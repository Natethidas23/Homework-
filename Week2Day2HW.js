...
// (shots made that count as 2 points each) 
// and three-pointers (shots made that count as 3 points each)
 ...
 function score(twoPointers,threePointers){
    if (twoPointers >= 12);{
        console.log("24");
    }
    if (threePointers >= 15);{
...
//2. Create a new file petstore.sql. 
//Create a pet store database, with 2 mySQL tables, 
//pets and owners. Each table should have at least 3 properties. 
//Insert one pet and one owner into appropriate tables.
